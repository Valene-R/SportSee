...
const Sidebar = () => {
  return (
    <aside className="relative flex h-[933px] w-[117px] flex-col justify-center bg-black">
      {/* Container for vertically aligned navigation icons */}
      <div className="absolute left-[26px] top-64 flex flex-col items-center justify-center space-y-5">
